...
//		String[] where_split = queryString.split(" where ");
//		String res = where_split[1].trim();
//		String[] final_str =new String[1];
//		final_str[0] =where_split[1].trim();
//
//
//		if (res.contains("order by"))
//		{
//			String[] order_split = res.split("order by");
//			String[] rest = new String[1];
//			rest[0]=order_split[0].trim();
//			return rest;
//
//		}
//		else if (res.contains("group by"))
//		{
//			String[] group_split = res.split("group by");
//			String[] rest = new String[1];
//			rest[0]=group_split[0].trim();
//			return rest;
//		}
//		else{
//
//			String str = final_str[0].trim();
//			if(str.contains("or")) {
//				String n= str.replace(" and "," or ");
//
//				String[] result = n.split(" or ");
//				for(int i=0;i<result.length;i++)
//				{
//					result[i] = result[i].toLowerCase().trim();
//				}
//				return  result;
//			}
//
//			if(str.contains(" and ")) {
//				String 	n = str.replace(" or "," and ");
//
//				String[] result = n.split(" and ");
//				for(int i=0;i<result.length;i++)
//				{
//					result[i] = result[i].toLowerCase().trim();
//				}
